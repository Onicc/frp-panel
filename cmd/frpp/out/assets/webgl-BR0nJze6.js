...
`,T=({inputs:e,output:n,target:i})=>{let o=n.type,s=l(o,1,n.normalized),c=d(s),u=e.namedInputs;return y({module:{name:`arithmetic`,dependencies:[a],vs:w},inputs:u,output:n,operationType:o,outputBuffer:i,expression:n=>r(e.expression,{operations:t,inputs:u,laneIndex:n,formatInput:e=>`${e}[${n}]`,formatOutOfBoundsInput:e=>u[e].size===1?`${e}[0]`:c,formatLiteral:e=>{let t=Array.isArray(e)?e[n]??0:e;return`${s}(${f(o,t)})`},formatCall:(e,t)=>`${e}(${t.join(`, `)})`})}),{success:!0}},E=`GPGPU Operation Counts`,D=`Transform Runs`,O=({inputs:t,output:r,target:i})=>{let{sourceValues:a}=t,c=i.device;if(a.length===0){let e=new r.ValueType(r.length*r.size);return i.write(e),{success:!0,value:e}}if(a.isConstant){let e=a.value,t=new r.ValueType(r.length*r.size);for(let n=0;n<r.length;n++){let r=e[n];t[n*2]=r,t[n*2+1]=r}return i.write(t),{success:!0,value:t}}let l=c.createTexture({width:1,height:r.length,format:`rg32float`,usage:o.RENDER|o.COPY_SRC|o.COPY_DST}),u=c.createFramebuffer({colorAttachments:[l]}),d=new s(c,{vs:`#version 300 es
...
void main() {
  ...
  `,h=new c(a,{vs:p,defines:{INDEX_TYPE:s,TYPE:u,RESULT_LEN:t.size.toString(),SOURCE_VALUES_ROWS:i.length.toString()},modules:[z(r,s),I(i,t.type,d),V(t.type),o],bindings:{source_values_texture:f},bufferLayout:[B(r)],vertexCount:1,instanceCount:t.length,feedbackBufferMode:`interleaved`,outputs:o.varyings});try{return h.run({inputBuffers:{ids:r.buffer},outputBuffers:{[o.varyings[0]]:n}}),{success:!0}}finally{h.destroy(),f.destroy()}};function z(e,t){let n=l(e.type,1),r=`aids_0`;return e.type!==H(t)&&(r=`${t}(${r})`),{name:`ids`,vs:`
in ${n} aids_0;
